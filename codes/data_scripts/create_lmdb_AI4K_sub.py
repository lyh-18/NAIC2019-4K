...
def VideoSR(mode):
    ...
    if mode == 'GT':
        img_folder = '/data0/yhliu/AI4K/contest1/train1_HR_png_sub3/'
        lmdb_save_path = '/data0/yhliu/AI4K/contest1/train1_HR_sub3.lmdb'
        H_dst, W_dst = 480, 480
    elif mode == 'LR':
        img_folder = '/data0/yhliu/AI4K/contest1/train1_LR_png_sub3/'
        lmdb_save_path = '/data0/yhliu/AI4K/contest1/train1_LR_sub3.lmdb'
        H_dst, W_dst = 120, 120
    ...
    for img_path in all_img_list:
        ...
        keys.append(clip + '_' + folder + '_' + img_name)
    ...
    meta_info = {}
    meta_info['name'] = 'AI4K_{}_train1_sub'.format(mode)
