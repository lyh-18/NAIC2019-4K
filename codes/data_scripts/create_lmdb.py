...
def main():
    dataset = 'REDS' #'vimeo90k' #'DIV2K_demo'  # vimeo90K | REDS | general (e.g., DIV2K, 291) | DIV2K_demo |test
...
def vimeo90k(mode):
    ...
    BATCH = 5000  # After BATCH images, lmdb commits, if read_all_imgs = False
    if mode == 'GT':
        img_folder = '/mnt/197_user/yhliu/DATA/Vimeo90K/vimeo_septuplet/sequences'
        lmdb_save_path = '/mnt/197_user/yhliu/DATA/Vimeo90K/vimeo90k_train_GT.lmdb'
        txt_file = '/mnt/197_user/yhliu/DATA/Vimeo90K/vimeo_septuplet/sep_trainlist.txt'
        H_dst, W_dst = 256, 448
    elif mode == 'LR':
        img_folder = '/mnt/197_user/yhliu/DATA/Vimeo90K/vimeo_septuplet_matlabLRx4/sequences'
        lmdb_save_path = '/mnt/197_user/yhliu/DATA/Vimeo90K/vimeo90k_train_LR7frames.lmdb'
        txt_file = '/mnt/197_user/yhliu/DATA/Vimeo90K/vimeo_septuplet/sep_trainlist.txt'
        H_dst, W_dst = 64, 112
    elif mode == 'flow':
        img_folder = '/mnt/197_user/yhliu/DATA/Vimeo90K/vimeo_septuplet/sequences_flowx4'
        lmdb_save_path = '/mnt/197_user/yhliu/DATA/Vimeo90K/vimeo90k_train_flowx4.lmdb'
        txt_file = '/mnt/197_user/yhliu/DATA/Vimeo90K/vimeo_septuplet/sep_trainlist.txt'
        H_dst, W_dst = 128, 112
    else:
...
def REDS(mode):
    ...
    BATCH = 5000  # After BATCH images, lmdb commits, if read_all_imgs = False
    if mode == 'train_sharp':
        img_folder = '/mnt/197_user/yhliu/DATA/REDS/train_sharp'
        lmdb_save_path = '/mnt/197_user/yhliu/DATA/REDS/train_sharp_wval.lmdb'
        H_dst, W_dst = 720, 1280
    elif mode == 'train_sharp_bicubic':
        img_folder = '/mnt/197_user/yhliu/DATA/REDS/train_sharp_bicubic'
        lmdb_save_path = '/mnt/197_user/yhliu/DATA/REDS/train_sharp_bicubic_wval.lmdb'
        H_dst, W_dst = 180, 320
    elif mode == 'train_blur_bicubic':
        img_folder = '/mnt/197_user/yhliu/DATA/REDS/train_blur_bicubic'
        lmdb_save_path = '/mnt/197_user/yhliu/DATA/REDS/train_blur_bicubic_wval.lmdb'
        H_dst, W_dst = 180, 320
    elif mode == 'train_blur':
        img_folder = '/mnt/197_user/yhliu/DATA/REDS/train_blur'
        lmdb_save_path = '/mnt/197_user/yhliu/DATA/REDS/train_blur_wval.lmdb'
        H_dst, W_dst = 720, 1280
    elif mode == 'train_blur_comp':
        img_folder = '/mnt/197_user/yhliu/DATA/REDS/train_blur_comp'
        lmdb_save_path = '/mnt/197_user/yhliu/DATA/REDS/train_blur_comp_wval.lmdb'
        H_dst, W_dst = 720, 1280
    elif mode == 'train_sharp_flowx4':
        img_folder = '/mnt/197_user/yhliu/DATA/REDS/train_sharp_flowx4'
        lmdb_save_path = '/mnt/197_user/yhliu/DATA/REDS/train_sharp_flowx4.lmdb'
        H_dst, W_dst = 360, 320
    n_thread = 40
    ########################################################
    if not lmdb_save_path.endswith('.lmdb'):
