    ...
    for epoch in range(start_epoch, total_epochs + 1):
        ...
        for _, train_data in enumerate(train_loader):
            ...
            if current_step % opt['logger']['print_freq'] == 0:
                ...
                message = '[epoch:{:3d}, iter:{:8,d}, time:{:.3f},lr:('.format(epoch, current_step, end_time-start_time)
                ...
                if opt['model'] in ['sr', 'srgan'] and rank <= 0:  # image restoration validation
                    ...
                    if opt['dist']:
                        ...
                        if rank == 0:
                            ...
                            log_s = '# Validation # PSNR: {:.5f}:'.format(psnr_total_avg)
            ...
            if current_step % opt['logger']['save_checkpoint_freq'] == 0:
                if rank <= 0:
                    ...
                    if opt['datasets'].get('val', None):
                        ...
                        psnr = val(opt['name'],current_step, opt['network_G']['which_model_G'])
                        print('1111111',psnr)
                        tb_logger.add_scalar('psnr_avg', psnr, current_step)
                    '''
