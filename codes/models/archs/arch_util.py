...
class ResidualBlock_noBN_3D(nn.Module):
    ...
    def __init__(self, nf=64):
        ...
        self.conv1 = nn.Conv3d(in_channels=nf, out_channels=nf, kernel_size=(3, 3, 3), stride=1, padding=(0,0,0), bias=True)
        self.conv2 = nn.Conv3d(in_channels=nf, out_channels=nf, kernel_size=(3, 3, 3), stride=1, padding=(0,0,0), bias=True)
