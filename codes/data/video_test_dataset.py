...
class VideoTestDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.imgs_GT_bic4x = {}
        if opt['name'].lower() in ['vid4', 'reds4','ai4k_val_small']:
            ...
            for subfolder_LQ, subfolder_GT in zip(subfolders_LQ, subfolders_GT):
                ...
                if self.cache_data:
                    ...
                    self.imgs_GT_bic4x[subfolder_name] = util.read_img_seq_bic4x(img_paths_GT)
    ...
    def __getitem__(self, index):
        ...
        if self.cache_data:
            ...
            img_GT_bic4x = self.imgs_GT_bic4x[folder][idx]
